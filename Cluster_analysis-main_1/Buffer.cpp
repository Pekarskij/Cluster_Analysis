...
Cloud Buffer::upload_cloud_from_buffer(int n)//vzyat' n-oe oblako v bufere
{
...
void Buffer::shift_cloud_in_buffer(int n, Point v) { clouds_in_buffer[n].shift_cloud(v); }

void Buffer::shift_all_clouds_in_buffer(Point v)
{
