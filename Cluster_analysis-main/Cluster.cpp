...
void Cluster::add_point_indicator(int n)//point_indicators[i]=1 - i-tay tochka polya v clustere, point_indicators[i]=0 - i-tay tochka polya ne v clustere
{
...
void Cluster::print_cluster(ofstream& file, vector <Point>& points)
{
